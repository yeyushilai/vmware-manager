...
IGNORE_PARAM_KEYS = ['time_stamp', 'version', 'owner', 'signature_method',
                     'access_key_id', 'zone', 'signature_version', 'service',
                     'user_id']
        ...
        for key, value in query_arguments.items():
            ...
            if not has_kwargs and key not in function_arguments:
                ...
                try:
                    ...
                    if key not in IGNORE_PARAM_KEYS:
                        logger.error("Function argument '{}' not defined in "
