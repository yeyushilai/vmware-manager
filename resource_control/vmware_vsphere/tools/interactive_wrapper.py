...
Starting point is instantiating a vsphere Host (VVC) in order
to get all VMs.
"""
...
class VVC(object):
    ...
    def __init__(self, hostname):
        ...
        - `hostname` (str) is the name of the vsphere host.
        """
        self.hostname = hostname

    def connect(self, username, password=None):
        """
        Connects to the vsphere host encapsulated by this VVC instance.
    ...
    def get_all_vms(self):
        """
        Returns a generator over all VMs known to this vsphere host.
        """
